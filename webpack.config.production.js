...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            'rn_html5Routing': JSON.stringify(appConfig.production.html5Routing),
            'rn_debug': JSON.stringify(appConfig.production.debug),
            'rn_urlPrefix': JSON.stringify(appConfig.production.urlPrefix),
            'rn_API_URL': JSON.stringify(appConfig.production.API_URL)
        }),
