...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'rn_html5Routing': JSON.stringify(appConfig.development.html5Routing),
      'rn_debug': JSON.stringify(appConfig.development.debug),
      'rn_urlPrefix': JSON.stringify(appConfig.development.urlPrefix),
      'rn_API_URL': JSON.stringify(appConfig.development.API_URL)
    }),
